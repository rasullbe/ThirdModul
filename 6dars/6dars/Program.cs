...
internal class Program
{
    static void Main(string[] args)
    {
        ...
        //Delegates - это тип данных, который может хранить ссылку на метод с определенной сигнатурой. Они позволяют вызывать методы косвенно, что полезно для событий и обратных вызовов.
        // Action - для методов, которые не возвращают значение.
        // Func - для методов, которые возвращают значение.
        // Predicate - для методов, которые возвращают булево значение и принимают один параметр.
